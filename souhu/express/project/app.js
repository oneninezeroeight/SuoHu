...
var DetailsImages2 = require('./routes/DetailsImages2')
var ImagesNews = require('./routes/Images-News')
...
app.use('/DetailsImages2', DetailsImages2);
app.use('/ImagesNews', ImagesNews);
